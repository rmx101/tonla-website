...
export default function EnglishHome() {
  ...
  return (
    <main className="min-h-screen bg-zinc-950">
      ...
      <nav className="fixed top-0 w-full bg-zinc-950/90 backdrop-blur-md border-b border-white/5 z-40">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <a href="#products" className="text-sm text-zinc-400 hover:text-white transition-colors hidden sm:inline">
              Products
            </a>
            <a href="#logistics" className="text-sm text-zinc-400 hover:text-white transition-colors hidden sm:inline">
              Logistics
            </a>
            <a href="#technology" className="text-sm text-zinc-400 hover:text-white transition-colors hidden sm:inline">
              AI Technology
            </a>
            <a href="#contact" className="text-sm text-zinc-400 hover:text-white transition-colors hidden sm:inline">
              Contact
            </a>
            <Link
              href="/"
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-10 sm:p-14 shadow-2xl max-w-2xl">
            ...
            <p className="text-zinc-600 mb-3 leading-relaxed">
              ...
              off-spec polymers &mdash; delivered with AI-powered supply chain
              management.
            </p>
      ...
      {/* AI Powered Section */}
      <section id="technology" className="relative py-24 px-6 bg-zinc-950 overflow-hidden">
        <div className="absolute inset-0 ai-grid pointer-events-none" />
        <div className="absolute inset-0 ai-glow pointer-events-none" />
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-400 max-w-2xl mx-auto">
              We optimize your supply chain processes with AI technology,
